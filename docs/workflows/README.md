...
This directory describes the intended workflow system for this pi setup.

These documents capture the current product vision and behavioral rules before implementation. They are the source of truth for the upcoming brainstorming, planning, and implementation work.
